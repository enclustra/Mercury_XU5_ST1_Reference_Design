...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0024 0xFE7FEDEF 0x7E4B0C82
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0020 0x00717F00 0x00015A00
		# : BY PASS PLL
		# Register : APLL_CTRL @ 0XFD1A0020</p>
    ...
    mask_write 0XFD1A0038 0x00717F00 0x00014800
		# : BY PASS PLL
		# Register : VPLL_CTRL @ 0XFD1A0038</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0068 0x013F3F07 0x01010602
    ...
    mask_write 0XFD1A0080 0x00003F07 0x00000201
    ...
    mask_write 0XFD1A00B8 0x01003F07 0x01000202
    ...
    mask_write 0XFD1A00BC 0x01003F07 0x01000202
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x02942B0D
